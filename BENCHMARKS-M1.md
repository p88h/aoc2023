...
```
Task             Python      PyPy3       Mojo        Mojo parallel  Improvement
Day1 Part1      1.15 ms     0.23 ms    [7.53 μs]    0.06 ms (x24)   * 30 - 150 '
Day1 Part2      4.99 ms     0.52 ms    [0.07 ms]    0.11 ms (x24)   * 7 - 70 ''
Day2 Part1      0.40 ms     0.16 ms    [0.09 ms]    0.03 ms (x24)   * 5 - 13 '
Day2 Part2      0.41 ms     0.16 ms    [0.09 ms]    0.03 ms (x24)   * 5 - 13 '
